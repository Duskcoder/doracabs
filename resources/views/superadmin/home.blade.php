        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                ...
                                <button type="button" onclick="createFunction()" class="btn btn-info mt-3">Add</button>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <!-- <a class=" btn btn-sm btn-primary btn-square" href="{{ route('carcreate') }}" role="button"><i
        ...
        @section('js-content')
            <script>
                function createFunction() {
                    window.location.href = "{{ route('carcreate') }}";
                }
            </script>
            <script type="text/javascript">
                $(function() {
                    var table = $('#dataTableId12').DataTable({
                        processing: true,
                        serverSide: true,
                        pageLength: 5,
                        lengthChange: false,
